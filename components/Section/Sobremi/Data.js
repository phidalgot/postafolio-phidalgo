...
![Sobre mi persona](/images/tablet-movil-desktop-web_portafolio.svg)
# Sobre mi

### Web Developer FullStack 🧑, ágil y pro-activo con amplía experiencia en creación de sitios web óptimos. Actualmente en los caminos JavaScript (ReactJS, React Native, Node.JS). Estoy en continua formación para mejorar y ampliar los conocimientos que he obtenido durante tantos años en este medio 🖥  
...
#### He trabajado en diferentes posiciones en el sector público y privado, he trabajado brindando soluciones tecnológicas desempeñando desempeñando difrentes roles  y actualmente full stack donde Cubro el espectro de la tecnología necesaria para desarrollar un proyecto completo por mi cuenta
